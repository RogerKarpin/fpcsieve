...
#elif defined(_MSC_VER) && defined(_M_X64borg)
  /* TODO: inline assembly not supported on x64 by Visual Studio 2012. Added "borg" to prevent this secion being compiled. */
  __asm { rdtsc
          shl     rdx, 32
          or      rax, rdx
